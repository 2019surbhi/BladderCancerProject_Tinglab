...
# This script merges copykat gene table outputs for multiple samples. Simply copy the desired tables to a directory 'gene_by_cell_tables' #
# Author: Surbhi Sona
...
write.table(uniq_merged_tab,paste0(dir,'gene_ref.txt',row.names=FALSE))
